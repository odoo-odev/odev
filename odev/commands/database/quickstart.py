...
class QuickStartCommand(DatabaseCommand):
    ...
    should_clone_repo = args.Flag(
        aliases=["-C", "--should-clone-repo"],
        default=Config().quickstart.should_clone_repo,
        description="Whether to clone the repository containing code customization for the selected database.",
    )
    ...
    def run(self):
        ...
        if self.args.version:
            ...
            if self.args.should_clone_repo:
